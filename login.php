...
if (isset($_POST['login'])) {
    ...
    if ($data = mysqli_fetch_assoc($result)) {
        // password_verify() membaca hash bcrypt yang dibuat password_hash() di register.php
...
<head>
  ...
  <title>Sign In · RosiMarket Hub</title>
  ...
  <style>
    *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
    ...
    .wrap{width:100%;max-width:360px;animation:fadeUp 0.45s ease;position:relative;}
...
<div class="wrap">
  ...
  <div class="card">
    <h1>Sign in</h1>
    <p class="sub">Masuk ke akun marketplace Anda</p>
    ...
    <form method="POST">
      ...
      <div class="fg">
        ...
        <div class="pw-wrap">
          ...
          <button type="button" class="pw-btn" onclick="togglePw(this,'pwInput')">Lihat</button>
        </div>
      </div>
    ...
    <span class="foot">Belum punya akun? <a href="register.php">Daftar sekarang</a></span>
  </div>
